...
public class SwaggerConfig implements WebMvcConfigurer {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.globalResponseMessage(RequestMethod.GET, Arrays.asList(m401, m404, m500))
				.globalResponseMessage(RequestMethod.POST, Arrays.asList(m201, m401, m422, m500))
				.globalResponseMessage(RequestMethod.PUT, Arrays.asList(m204put, m401, m404, m422, m500))
				.globalResponseMessage(RequestMethod.DELETE, Arrays.asList(m204del, m401, m404, m500))
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.fiap.saveshare"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				"API do projeto final curso de Análise e desenvolvimento de sistemas FIAP",
				"Grupo Save & Share",
				"Versão 1.0",
				"https://www...",
				new Contact("","",""),
